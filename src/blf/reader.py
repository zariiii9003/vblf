...
OBJ_MAP: Final[dict[int, Optional[type[ObjectWithHeader]]]] = {
    ...
    ObjTypeEnum.ENV_INTEGER.value: EnvironmentVariable,
    ObjTypeEnum.ENV_DOUBLE.value: EnvironmentVariable,
    ObjTypeEnum.ENV_STRING.value: EnvironmentVariable,
    ObjTypeEnum.ENV_DATA.value: EnvironmentVariable,
